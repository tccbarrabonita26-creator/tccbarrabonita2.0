        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData("Events",
                ...
                new object[,]
                {
                    ...
                    { 2, "Regata do Rio", "Competição de barcos a vela e jet-ski com participação de atletas de todo o estado.", new DateTime(2025,8,20), new DateTime(2025,8,22), "Rio de Barra Bonita", "/images/eventos/regata.jpg", true, "Esportivo" },
            ...
            migrationBuilder.InsertData("FAQs",
                ...
                new object[,]
                {
                    ...
                    { 3, "Precisa pagar para acessar o Rio?", "Não, o acesso ao Rio e à Orla é gratuito. Apenas atividades como aluguel de barcos e passeios turísticos têm custo.", 3 },
                    { 4, "Onde se hospedar?", "A cidade conta com hotéis, pousadas e chalés às margens do Rio. Recomendamos o Hotel Barra Bonita Resort, Pousada do Rio e Recanto do Pescador.", 4 },
                    { 5, "É permitido nadar no Rio?", "A natação é permitida apenas em áreas designadas e com supervisão. Recomendamos usar os clubes e praias artificiais para maior segurança.", 5 }
                });
            ...
            migrationBuilder.InsertData("GuideItems",
                ...
                new object[,]
                {
                    { 1,  "Hospedagem",  "Hotel Barra Bonita Resort",    "Resort completo com piscinas, sauna, academia e acesso direto ao Rio.",             "Av. Beira Rio, 1000",               "(14) 3604-1234", "www.hotelbarrabonita.com", "/images/guia/resort.jpg",       5 },
                    { 2,  "Hospedagem",  "Pousada do Rio",              "Aconchegante pousada familiar com vista para o Rio e café colonial.",               "Rua das Flores, 45",                 "(14) 3604-5678", "www.pousadadoRio.com",    "/images/guia/pousada.jpg",      4 },
                    { 3,  "Hospedagem",  "Chalés Recanto do Pescador",   "Chalés rústicos com estrutura para pesca e churrasqueira.",                          "Estrada do Rio, Km 3",              "(14) 3604-9012", null,                       "/images/guia/chales.jpg",       4 },
                    { 4,  "Gastronomia", "Restaurante Peixe Vivo",       "Especializado em peixes do Rio, com destaque para a moqueca e o peixe na telha.",  "Av. Marginal, 200",                  "(14) 3604-3456", "www.peixevivo.com",        "/images/guia/peixevivo.jpg",    5 },
                    ...
                    { 6,  "Gastronomia", "Churrascaria do Rio",         "Rodízio de carnes nobres com buffet completo e música ao vivo aos finais de semana.","Av. Beira Rio, 500",                "(14) 3604-2345", null,                       "/images/guia/churrascaria.jpg", 5 },
                    ...
                    { 8,  "Atividades",  "Aluguel de Barcos e Jet-skis", "Aluguel de lanchas, jet-skis, caiaques e pedalinhos.",                               "Marina Barra Bonita, Av. Beira Rio","(14) 3604-1111", "www.marinabarra.com",      "/images/guia/barcos.jpg",       5 },
                    { 9,  "Atividades",  "Passeio de Escuna",            "Passeio guiado pelo Rio com parada para banho e almoço.",                           "Píer Turístico",                     "(14) 3604-2222", null,                       "/images/guia/escuna.jpg",       5 },
                    ...
                    { 11, "Atividades",  "Pesca Esportiva",              "Passeios de barco para pesca com equipamentos e iscas inclusos.",                    "Pesqueiro do Rio",                  "(14) 3604-4444", null,                       "/images/guia/pesca.jpg",        4 }
                });
        }
